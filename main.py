...
parser.add_argument('--ny_in', type=int, default=664, dest='ny_in')
parser.add_argument('--nx_in', type=int, default=654, dest='nx_in')
...
parser.add_argument('--ny_out', type=int, default=664, dest='ny_out')
parser.add_argument('--nx_out', type=int, default=654, dest='nx_out')
...
parser.add_argument('--num_freq_save', type=int,  default=30, dest='num_freq_save')
