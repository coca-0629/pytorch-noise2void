...
class UNet(nn.Module):
    def __init__(self, nch_in, nch_out, nch_ker=64, norm='bnorm'):
        ...
        self.pool1 = Pooling2d(pool=2, type='avg', ceil=False)
        ...
        self.pool2 = Pooling2d(pool=2, type='avg', ceil=True)
        ...
        self.pool3 = Pooling2d(pool=2, type='avg', ceil=False)
        ...
        self.pool4 = Pooling2d(pool=2, type='avg', ceil=False)
    ...
    def forward(self, x):
        ...
        self.unpool4 = nn.Upsample(size=[enc4.shape[2],enc4.shape[3]], mode='nearest')
        ...
        self.unpool2 = nn.Upsample(size=[enc2.shape[2],enc2.shape[3]], mode='nearest')
...
class ResUNet(nn.Module):
    def __init__(self, nch_in, nch_out, nch_ker=64, norm='bnorm'):
        ...
        self.unpool4 = nn.Upsample(size=[83,82], mode='nearest')
        ...
        self.unpool2 = nn.Upsample(size=[332,327], mode='nearest')
